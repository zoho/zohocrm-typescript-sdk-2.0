...
Constants.REQUIRED_IN_UPDATE = "required-in-update";
...
Constants.SKIP_MANDATORY = "skip-mandatory";
...
Constants.PROXY_MANDATORY_KEYS = ["host", "port"];
...
Constants.OWNER_LOOKUP = "ownerlookup";
